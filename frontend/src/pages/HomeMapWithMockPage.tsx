...
const createMockIssues = (selectedCity: AppShellOutletContext['selectedCity']): MapIssue[] => {
  ...
  const drafts: Array<{
    ...
    },
    {
      ...
      description: 'Аула ішіндегі шам бағаны жөндеуді күтіп тұр.',
      status: 'in_progress',
      priority: 'medium',
    ...
    },
    {
      ...
      description: 'Тазалау жұмыстары аяқталып, аймақ қайта қалыпқа келтірілді.',
      status: 'resolved',
      priority: 'low',
...
export const HomeMapWithMockPage = () => {
  const { user } = useAuth();
        ...
        <div className="dashboard-map__layout">
          <div className="dashboard-map__viewport dashboard-map__viewport--compact">
            <MapContainer center={DEFAULT_CENTER} zoom={DEFAULT_ZOOM} scrollWheelZoom className="dashboard-map__leaflet">
              ...
              />
              <MapViewportSync issues={visibleIssues} />
            ...
            {usingMockIssues ? <div className="dashboard-map__mock-badge">Mock demo дерек</div> : null}
          </div>
